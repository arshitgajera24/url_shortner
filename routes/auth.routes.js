...
router.route("/edit-profile").get(authControllers.getEditProfilePage).post(avatarUpload.single('avatar'), authControllers.postEditProfile)       //post(authControllers.postEditProfile);
